...
config_materialized_excel = """
  {{ config(materialized="external", format="xlsx", location="test_excel.xlsx") }}
"""
...
excel_table_sql = config_materialized_excel + model_base
...
class BaseExternalMaterializations:
    ...
    def models(self):
        return {
            ...
            "table_excel.sql": excel_table_sql,
